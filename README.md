...
This repository showcases my cybersecurity projects, technical labs, and research work.  
The projects highlight my interest in cybersecurity, security testing, IT governance, cyber risk, and the impact of cyber incidents on organisations.  
...
- **Key Points:**  
  - Case studies included **Capital One, Equifax, RSA, Uber, and Advanced Computer Software Group/NHS**.  
...
- **Key Points:**  
  ...
  - Used **Metasploit** to validate exploitability of vulnerable services.  
  - Demonstrated **privilege escalation** in a controlled lab environment.  
  - Extracted password-related files and performed **password auditing using John the Ripper**.  
...
- **Key Points:**  
  ...
  - Demonstrated **Server-Side Request Forgery (SSRF)** and bypassed weak blacklist-based filtering in a lab environment.  
  - Analysed **authorisation bypass** caused by weak server-side access control enforcement.  
  - Demonstrated **command injection** caused by insecure handling of user input.  
